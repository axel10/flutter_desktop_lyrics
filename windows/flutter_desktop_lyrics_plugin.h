...
class FlutterDesktopLyricsPlugin : public flutter::Plugin {
 public:
  ...
  FlutterDesktopLyricsPlugin(const FlutterDesktopLyricsPlugin&) = delete;
  FlutterDesktopLyricsPlugin& operator=(const FlutterDesktopLyricsPlugin&) = delete;
